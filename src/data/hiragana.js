...
// บรรทัดนี้สำคัญที่สุดครับ! ต้องมี
// --- ส่วนท้ายของไฟล์ hiragana.js ---

// 1. ส่งออกสำหรับไฟล์ที่เรียกแบบ { hiraganaData } (เช่น HiraganaGame ตัวเก่า)
export { hiraganaData };

// 2. ส่งออกสำหรับไฟล์ที่เรียกแบบ hiraganaData (เช่น HiraganaChart ตัวใหม่)
